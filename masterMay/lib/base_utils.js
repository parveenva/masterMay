this.sendPeopleVerificationEmail = function (id,email){
  ...
  var tokenRecord = {
	...
	console.log("base 22");
	 ...
	 Meteor.call("peopleUpdateByID",id,tokenRecord  , function(e, r) { if(e) errorAction(e)});   

  	console.log("base 33");
  	  const url = Accounts.urls.verifyEmail(token);

const options = generateOptionsEmail(email, "user", url, 'verifyPeople');
...
this.generateOptionsEmail = function (email, user, url, reason) {
  ...
  var options = {
    to: email,
    from:  'Open College Essays <info@openessays.org>',
    subject: "Open College Essays - confirm your email address."
  };
...
<body class="body" style="font-family: -apple-system, BlinkMacSystemFont, Roboto, Ubuntu, Helvetica, sans-serif; line-height: initial; max-width: 580px;">
	...
	<h1 style="box-sizing: border-box; font-size: 1.25rem; margin: 0; margin-bottom: 0.5em; padding: 0;">Thanks for submitting Essays!</h1>
